...
from tensorflow.keras.layers import BatchNormalization, Activation, Conv3D, Add, Dense, Flatten, GlobalAveragePooling3D, MaxPooling3D, ConvLSTM2D, AveragePooling3D
...
class Resnet3DBuilder(object):
  ...
  def build(input_shape, num_outputs, block_fn, repetitions, reg_factor):
      ...
      if num_outputs > 1:
          lstm1=ConvLSTM2D(filters=64, kernel_size=(3,3),
                        strides=(1,1),padding='same',
                            kernel_initializer='he_normal', recurrent_initializer='he_normal',
                            kernel_regularizer=l2(0.00005), recurrent_regularizer=l2(0.00005),
                            return_sequences=True, name='gatedclstm2d_2')
          lstm2=ConvLSTM2D(filters=64, kernel_size=(3,3),
                        strides=(1,1),padding='same',
                            kernel_initializer='he_normal', recurrent_initializer='he_normal',
                            kernel_regularizer=l2(0.00005), recurrent_regularizer=l2(0.00005),
                            return_sequences=True, name='gatedclstm2d_2')
          lstm3=ConvLSTM2D(filters=64, kernel_size=(3,3),
                        strides=(1,1),padding='same',
                            kernel_initializer='he_normal', recurrent_initializer='he_normal',
                            kernel_regularizer=l2(0.00005), recurrent_regularizer=l2(0.00005),
                            return_sequences=True, name='gatedclstm2d_2')
          average=GlobalAveragePooling3D()
          #drop=Dropout(0.2)
