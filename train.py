...
# from tensorflow.keras.layers import Dense, Dropout, Activation, Flatten, Reshape, Conv3D, MaxPooling3D,Conv2D,AveragePooling2D,AveragePooling3D
# from tensorflow.keras.layers import GlobalAveragePooling3D,GlobalAveragePooling2D, BatchNormalization, ConvLSTM2D
# from tensorflow.keras.callback import EarlyStopping, ModelCheckpoint, LearningRateScheduler,ReduceLROnPlateau
...
data = DataLoader()
X_tr_array = data.prepare_data(img_rows, img_cols)
