...
path_dest = 'Sliding Two Fingers Left/' # The folder where we will put all our training samples
path_source ='jester_20bn/20bn-jester-v1/' # The folder that contains all the data (Jester 20bn)
csv_file = 'data_csv/jester-v1-train.csv' # training csv file

file = open(csv_file, 'r')
reader = csv.reader(file, delimiter=';')
count = 0
simple = 300 #number of samples by class for training
class_ = ['Sliding Two Fingers Left'] # The classes we want to use
rows = []
